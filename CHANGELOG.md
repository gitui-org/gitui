...
* syntax highlighting in the diff view ([Shift+X] cycles style: off / gutter / +- sign / tint) [[@stevenpollack](https://github.com/stevenpollack)] ([#2997](https://github.com/gitui-org/gitui/pull/2997))
